        ...
        <form action={formAction} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label htmlFor="price_per_thumbnail" className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">Rate / Delivery (₹)</label>
                <input 
                  type="number" 
            ...
            <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
               <div>
                  ...
                  <p className="text-2xl font-black text-indigo-600 tracking-tighter">₹{totalPrice.toLocaleString()}</p>
               </div>
               <input 
                  type="hidden" 
                  name="monthly_price" 
