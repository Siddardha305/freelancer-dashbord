      ...
      {showSuccess ? (
        <div className="flex flex-col items-center justify-center py-10 space-y-6 text-center animate-in zoom-in-95 duration-300">
          ...
          <div className="w-full flex flex-col gap-3 px-2">
            <button 
              onClick={() => (state as any).payment && downloadInvoice((state as any).payment)}
        ...
        <form action={formAction} className="space-y-6 p-2">
          ...
          <div className="space-y-2">
            <label htmlFor="amount" className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Amount (₹)</label>
