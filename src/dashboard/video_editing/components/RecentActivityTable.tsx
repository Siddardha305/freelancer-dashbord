...
export function RecentActivityTable({ clients, formatCurrency }: RecentActivityTableProps) {
  return (
    <div className="bg-white dark:bg-slate-955/60 rounded-[2rem] border border-slate-200 dark:border-slate-800/80 shadow-sm overflow-hidden">
      <div className="border-b border-slate-100 dark:border-slate-800/60 px-4 sm:px-8 py-6 flex items-center justify-between">
        <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100 uppercase tracking-wider">Partner Channel Brands</h2>
        <Link 
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-slate-50/50 dark:bg-slate-900/30">
              <th className="px-4 sm:px-6 py-5 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Creator Channel</th>
              <th className="px-4 sm:px-6 py-5 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Niche / Scope</th>
              <th className="px-4 sm:px-6 py-5 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Sponsorship / Rate</th>
              ...
              <tr>
                <td colSpan={4} className="px-10 py-24 text-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">No brand channels configured</p>
                  </div>
                </td>
              </tr>
            )}
