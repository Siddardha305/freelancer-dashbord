...
import { LayoutDashboard, Sparkles, Video } from "lucide-react";
    ...
    <header className="flex min-h-[4.5rem] shrink-0 items-center justify-between gap-4 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/85 dark:bg-slate-950/40 backdrop-blur-md px-6 sm:px-12 py-4 flex-wrap">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <h1 className="text-xs sm:text-sm font-black uppercase tracking-widest text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
            Video & Thumbnail Hub <Sparkles className="h-3 w-3 text-amber-500 animate-pulse" />
          </h1>
          <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Creative Suite Dashboard</p>
        </div>
      </div>
