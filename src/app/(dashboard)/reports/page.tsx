                  ...
                  <tbody className="divide-y divide-slate-100">
                    {clientStats.map((s) => (
                      <tr key={s.client.id} className="hover:bg-slate-50/60 transition-colors group">
                        ...
                        {/* Rate */}
                        <td className="px-6 py-5">
                          <span className="text-sm font-black text-slate-700">₹{s.rate.toLocaleString()}</span>
                        </td>
                        {/* Earned this month */}
                        <td className="px-6 py-5">
                          <span className="text-sm font-black text-emerald-600">₹{s.earnedThisMonth.toLocaleString()}</span>
                        </td>
                        {/* Monthly target */}
                        <td className="px-6 py-5">
                          <span className="text-sm font-black text-slate-500">₹{s.monthlyTarget.toLocaleString()}</span>
                        </td>
                        {/* Progress bar */}
