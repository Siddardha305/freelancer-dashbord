            ...
            <div className="glass-bg rounded-[2.5rem] p-8 border border-card-border overflow-hidden relative space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 space-y-2">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-black text-amber-600 dark:text-amber-400 tracking-tight">{formatCurrency(pendingAmount)}</span>
                  </div>
                  <p className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 space-y-2">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-black text-indigo-600 dark:text-indigo-400 tracking-tight">{formatCurrency(amountBalance)}</span>
                  </div>
                  <p className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">
            ...
            <div className="premium-card rounded-[2rem] p-8 space-y-8">
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">{formatCurrency(client.monthly_price || client.price_per_thumbnail)}</p>
                  </div>
                  <div>
               ...
               <div className="pt-8 border-t border-slate-100 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900 tracking-tight">{formatCurrency(client.totalEarned || 0)}</p>
                  </div>
